...
export default function LocalSection() {
    return (
        <section className="py-12 sm:py-16 lg:py-24 bg-slate-900 relative overflow-hidden" id="nous-trouver">
            {/* Background pattern */}
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10 items-stretch">
                    ...
                    <div className="flex flex-col gap-6">
                        {/* Contact cards */}
                        <div className="bg-slate-800/60 backdrop-blur border border-slate-700 rounded-2xl sm:rounded-3xl p-6 sm:p-8 flex flex-col gap-5">
                    ...
                    {/* Right — Google Maps */}
                    <div className="rounded-2xl sm:rounded-3xl overflow-hidden border border-slate-700 shadow-2xl min-h-[300px] sm:min-h-[420px]">
                        <iframe
