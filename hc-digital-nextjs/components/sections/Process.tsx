...
export default function Process() {
    return (
        <section className="py-24 bg-background-light dark:bg-background-dark relative overflow-hidden" id="process">
                    ...
                    <div className="space-y-8">
                        {processSteps.map((step, index) => (
                            ...
                            >
                                ...
                                {/* Contenu */}
                                <div className={`ml-20 md:ml-0 md:w-[calc(50%-3rem)] ${index % 2 === 0 ? 'md:pr-8 md:text-right' : 'md:pl-8 md:text-left'}`}>
                                    <div
                                        className={`p-6 rounded-2xl bg-white dark:bg-surface-dark border shadow-md hover:shadow-lg transition-shadow ${step.clientAction
