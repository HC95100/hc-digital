...
export default function Advantages() {
    return (
        <section className="py-24 bg-background-light dark:bg-background-dark relative" id="advantages">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-3 gap-6 h-auto">
                    ...
                    <div className="md:col-span-2 md:row-span-2 bg-gradient-to-br from-primary to-blue-900 rounded-3xl p-8 flex flex-col justify-between text-white relative overflow-hidden group hover:shadow-glow-blue transition-all duration-500">
                        ...
                        <div>
                            ...
                            <h3 className="text-3xl font-bold mt-6">Plus de clients, plus de CA</h3>
                    ...
                    <div className="md:col-span-2 bg-slate-900 rounded-3xl p-8 flex items-center justify-between relative overflow-hidden group hover:shadow-lg transition">
                        <div className="absolute inset-0 grid-pattern opacity-10" />
                        <div className="relative z-10">
                            <h3 className="font-bold text-white text-2xl">Renforcez votre crédibilité</h3>
                    ...
                    <div className="md:col-span-2 bg-gradient-to-r from-slate-800 to-slate-900 rounded-3xl p-8 flex items-center justify-between relative overflow-hidden group hover:shadow-lg transition">
                        <div className="absolute inset-0 grid-pattern opacity-10" />
                        <div className="relative z-10">
